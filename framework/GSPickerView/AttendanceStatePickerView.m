...
@interface AttendanceStatePickerView()<UIPickerViewDelegate, UIPickerViewDataSource>
...
@implementation AttendanceStatePickerView
...
- (void)loadData
{
    ...
    [self.startTimeArray addObject:@"未出勤"];
    [self.startTimeArray addObject:@"已出勤"];
    [self.startTimeArray addObject:@"请假"];
    [self.startTimeArray addObject:@"旷课"];
    [self.startTimeArray addObject:@"请假已补"];
    [self.startTimeArray addObject:@"旷课已补"];
